...
exports.limits = {
  ...
  recordOverhead: 250,           // Mileage may vary, with message attributes
...
function extractMessageGroups(records){
  ...
  allRecords.forEach(function(value, key){
    //extract the key
    var eventType = value.eventMetadata.eventType;
    var keyPart3 = "";
    var keyPart4 = "";
    if (eventType == "entity") {
      keyPart3 = value.entityMetadata.entityType;
      keyPart4 = value.entityMetadata.operation;
    }
    else if (eventType == "action") {
        keyPart3 = value.actionMetadata.actionType;
        keyPart4 = value.actionMetadata.actionCategory;
    }
    var keyGroups = [eventType, value.eventMetadata.emittedBy, keyPart3, keyPart4];
      ...
      switch(i){
        ...
        case 2:
          if (eventType == "entity")
            ...
            attributes["actionType"] = {DataType: 'String', StringValue: item};
        break;
        ...
        case 3:
          if (eventType == "entity")
            ...
            attributes["actionCategory"] = {DataType: 'String', StringValue: item};
        break;
      }
    }
  }
